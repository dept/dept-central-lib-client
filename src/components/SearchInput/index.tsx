        ...
        >
          <MagnifyingGlassIcon
            className={classNames(
              !disabled ? 'text-[color:var(--search-scheme)]' : 'opacity-50',
          ...
          <input
            ...
            className={classNames(
              ...
              disabled ? '' : 'bg-white',
              'block w-full h-[3rem] rounded-md focus:outline-none focus:border-[color:var(--search-border-color)] text-grayscale-500 placeholder-grayscale-500 py-4 pr-4 pl-12 gap-3 shadow  group-hover:shadow-md disabled:cursor-not-allowed',
            )}
